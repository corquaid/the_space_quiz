...
const Russia = ({ quizData }) => {
    const imageUrl =
        "https://upload.wikimedia.org/wikipedia/commons/1/1b/ISS-30_EVA_Oleg_Kononenko_and_Anton_Shkaplerov_2.jpg";

    const tooltip =
        "Cosmonauts Oleg Kononenko and Anton Shkaplerov during a spacewalk outside the International Space Station in February 2012. Credit: NASA";
    return (
        <>
            <Head>
