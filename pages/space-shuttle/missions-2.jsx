...
const Missions2 = ({ quizData }) => {
    const imageUrl =
        "https://upload.wikimedia.org/wikipedia/commons/5/53/Space_shuttles_Atlantis_%28STS-125%29_and_Endeavour_%28STS-400%29_on_launch_pads.jpg";

    const tooltip =
        "Space Shuttles Atlantis (foreground) and Endeavour on adjacent launch pads at Kennedy Space Center in September 2008. Credit: NASA";
    return (
        <>
            <Head>
