...
const ScoreModal = ({ score, showScore, handleClose, categoryRaw, categoryFormatted, quizNameRaw }) => {
    ...
    switch (score) {
        case 0:
            modalMessage = <h3>Sorry, your launch has been scrubbed.</h3>;
            break;
        case 1:
        case 2:
        case 3:
            modalMessage = <h3>You're suborbital - might need a bigger rocket.</h3>;
            break;
        case 4:
        case 5:
        case 6:
            modalMessage = <h3>You're in Low Earth Orbit, how's the view?</h3>;
            break;
        case 7:
        case 8:
        case 9:
